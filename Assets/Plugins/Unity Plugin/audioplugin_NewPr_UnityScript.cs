...
public class audioplugin_NewPrGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "audioplugin_NewPr"; } }
    public override string Description    { get { return "NewPr"; } }
    public override string Vendor         { get { return "yourcompany"; } }

    //==============================================================================
	[DllImport("audioplugin_NewPr")] static extern System.IntPtr getRenderCallback();

    [DllImport("audioplugin_NewPr")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("audioplugin_NewPr")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_NewPr")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_NewPr")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("audioplugin_NewPr")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("audioplugin_NewPr")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
